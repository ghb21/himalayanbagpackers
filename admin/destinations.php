 ...
 if(strlen($_SESSION['alogin'])==0){
   ...
   if(isset($_POST['submit'])){
    ...
    if (!in_array($extension, $allowed_extensions)) {
        ...
        $folder = "destimg/" . $img . "." . $extension;
        $img = $img . "." .$extension;
        if(move_uploaded_file($_FILES["image"]["tmp_name"], $folder)){
            $query=mysqli_query($con, "INSERT INTO `destination`(`DestinationName`,`Pictures`,`Description`)VALUES('$destname','$img','$description')");
            if($query){
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="booking.php"><i class="menu-icon icon-inbox"></i>Booking Query<b class="label green pull-right">
                                <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($row["Status"]=='Active'){ ?>
                                                   ...
                                                   <?php }
                                                    ...
                                                    <button class="btn btn-danger">* Not Live</button>
                                                <?php }
                                                ?></td>
                                                <td><?php echo $row["CreationDate"]; ?></td>
                                                <td><?php echo $row["UpdationDate"]; ?></td>
                                                <td><a href="javascript:void(0);" onClick="popUpWindow('updatedest.php?d_id=<?php echo $row['Id']; ?>');" title="Update Status"><button class="btn btn-info btn" type="button"><i class="icon-edit"></i>Update Status</button></a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                                    ...
                                    <form class="form-vertical style-form" action="" method="post" enctype="multipart/form-data">
                                        <div class="form-horizontal row-fluid">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="destname" placeholder="Destination name" class="span8" required>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label" for="basicinput">Description</label>
                                                <div class="controls">
                                                    <textarea name="description" id="desdescription"class="span8" rows="5" cols="10" placeholder="Description"></textarea>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label" for="basicinput">Destination</label>
                                                <div class="controls">
                                                    <input type="file" name="image" placeholder="Destination Image" class="span8" required>
                                                </div>
                                            </div>
                                            
                                            <div class="control-group">
                                                <div class="controls">
                                                    <button type="submit" name="submit" id="submit" value="submit" class="btn btn-info"><i class="icon-save"></i> Add Destination</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
